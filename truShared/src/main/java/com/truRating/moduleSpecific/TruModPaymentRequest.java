package com.truRating.moduleSpecific;
 ...
 */
public class TruModPaymentRequest implements IPaymentRequest {
    ...
    public TruModPaymentRequest(Double transactionValue) {
        this.transactionValue = transactionValue;
    }

    public TruModPaymentRequest(String product, BigDecimal amount) {
