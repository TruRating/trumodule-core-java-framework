...
public class XMLNetworkMessenger implements IXMLNetworkMessenger {
     ...
     */
    public synchronized QuestionResponseJAXB getQuestionFromService(ITruModuleProperties properties) {
        ...
        try {
            ...
            //output stream....
            questionMarshaller.marshal(truRatingMessageFactory.assembleARequestQuestion(properties), questionWriter);
    ...
    public RatingResponseJAXB deliveryRatingToService(Rating rating, IPaymentResponse paymentResponse, ITruModuleProperties properties) {
        final CountDownLatch countDownLatch = new CountDownLatch(1);
        ...
        try {
            ...
            ratingMarshaller.marshal( truRatingMessageFactory.assembleARatingDelivery(rating, paymentResponse, properties), ratingWriter);
