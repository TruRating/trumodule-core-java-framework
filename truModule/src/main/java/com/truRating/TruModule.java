...
public class TruModule implements ITruModule, Runnable {
    ...
    public Rating doRating(IPaymentRequest paymentRequest, ITruModuleProperties properties) {
        ...
        try {        	
            final QuestionResponseJAXB questionResponseJAXB = xmlNetworkMessenger.getQuestionFromService(properties, paymentRequest.getTransactionReference());
    ...
    public boolean recordRatingResponse(IPaymentResponse paymentResponse, Rating rating, ITruModuleProperties properties) {
        ...
        try {
            //send the rating
            final RatingResponseJAXB ratingResponseJAXB = xmlNetworkMessenger.deliveryRatingToService(rating, paymentRequest.getTransactionReference(), paymentResponse, properties);
