...
public class TruRatingMessageFactory {
    ...
    public QuestionRequestJAXB assembleARequestQuestion(com.trurating.properties.ITruModuleProperties propertiesProvided, long transactionId) {
    ...
    public RatingDeliveryJAXB createRatingRecord(ITruModuleProperties propertiesProvided) {
        ...
        RatingDeliveryJAXB.Rating rating = ratingDeliveryJAXB.getRating() ;
		Date now = new Date();
